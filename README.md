...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fbqq7a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fbqq7a.containers.anotherwebservice.com/
...
```
git clone git@github.com:catpicseveryday/container-fbqq7a.git
cd container-fbqq7a
```
...
```
docker attach container-fbqq7a
```
